...
- [Remove feature flag active_storage_s3](https://github.com/CircuitVerse/CircuitVerse/issues/7627)
...
- [Add JSON output to the demo visual-comparison tool](https://github.com/RoryGlenn/commitment-issues/issues/144)
- [Add a coverage-scope inspection command](https://github.com/RoryGlenn/commitment-issues/issues/143)
- [Document how to add and preview a message state](https://github.com/RoryGlenn/commitment-issues/issues/118)
- [Add a five-minute disposable-repository tutorial](https://github.com/RoryGlenn/commitment-issues/issues/117)
- [Add a beginner-friendly Git terminology glossary](https://github.com/RoryGlenn/commitment-issues/issues/115)
...
## [aces/EEG2BIDS](https://github.com/aces/EEG2BIDS)

- [[feature] Add scans metadata validation ](https://github.com/aces/EEG2BIDS/issues/127)
- [[feature] Add recording parameters validation](https://github.com/aces/EEG2BIDS/issues/126)
- [Read Project, Subproject(cohort), Visit, Site from *_parameters.json](https://github.com/aces/EEG2BIDS/issues/91)
- [default readme in BIDS dataset after conversion](https://github.com/aces/EEG2BIDS/issues/88)
...
## [SabakiHQ/Sabaki](https://github.com/SabakiHQ/Sabaki)

- [Feature suggestion: When hovering (about to place a stone), highlight the hovered intersection](https://github.com/SabakiHQ/Sabaki/issues/970)
- [Beginner suggestion - Engine management - ADD labels](https://github.com/SabakiHQ/Sabaki/issues/756)
- [Add keyboard shortcuts for copy, paste, cut, delete node](https://github.com/SabakiHQ/Sabaki/issues/579)
- [Add ruleset field to game info drawer](https://github.com/SabakiHQ/Sabaki/issues/390)
- [Feature request - Limit policy heatmap to top moves / threshold](https://github.com/SabakiHQ/Sabaki/issues/975)

## [hexcreator/tasc](https://github.com/hexcreator/tasc)

- [Add another 60-second TascLang task fixture](https://github.com/hexcreator/tasc/issues/3)
- [Write buyer, worker, and verifier walkthroughs](https://github.com/hexcreator/tasc/issues/1)

## [Azure/git-ape](https://github.com/Azure/git-ape)

- [Author eval suite for agent `azure-template-generator`](https://github.com/Azure/git-ape/issues/94)
...
- [[BUG]: Select tools don't select all points within area when selection crosses the antimeridian](https://github.com/plotly/plotly.js/issues/7904)
...
- [Document Warning Code AVX_W17 (SECURITY_SANITIZED_ATTRIBUTE)](https://github.com/Avenx-JS/avenx-js/issues/451)
- [Document Warning Code AVX_W21 (DIRECTIVE_HTML_EVALUATION_FAILED)](https://github.com/Avenx-JS/avenx-js/issues/455)
- [Document Warning Code AVX_W22 (DIRECTIVE_SHOW_EVALUATION_FAILED)](https://github.com/Avenx-JS/avenx-js/issues/456)
...
- [Document Warning Code AVX_W16 (SECURITY_SANITIZED_TAG)](https://github.com/Avenx-JS/avenx-js/issues/450)
- [Document Warning Code AVX_W15 (COMPONENT_INJECT_KEY_NOT_FOUND)](https://github.com/Avenx-JS/avenx-js/issues/449)
...
- [Document Warning Code AVX_W11 (ROUTE_TITLE_EVALUATION_FAILED)](https://github.com/Avenx-JS/avenx-js/issues/444)
...
- [Document Warning Code AVX_W02 (COMPILER_EMPTY_TEMPLATE)](https://github.com/Avenx-JS/avenx-js/issues/435)
...
- [Clarify Live Reload vs Hot Reload in CLI reference](https://github.com/Avenx-JS/avenx-js/issues/366)
- [Document Parameter Access via Implicit `args` Array inside Actions](https://github.com/Avenx-JS/avenx-js/issues/363)
...
- [Complete truncated AvenxRouter & Guard API documentation](https://github.com/Avenx-JS/avenx-js/issues/288)
- [Support Wildcard Path Matchers in Route Patterns](https://github.com/Avenx-JS/avenx-js/issues/209)
- [Component System: Add `onBeforeMount` Lifecycle Hook](https://github.com/Avenx-JS/avenx-js/issues/208)
...
- [[ACTION] Add action to process a refund for Shopify orders](https://github.com/PipedreamHQ/pipedream/issues/21406)
- [Feature Request: Expand Monta Connector Coverage](https://github.com/PipedreamHQ/pipedream/issues/21405)
- [[ACTION] Add actions for Shopify Discount Code REST endpoints (get, update, delete, batch create)](https://github.com/PipedreamHQ/pipedream/issues/21402)
- [[ACTION] Add support for unsubscribing a contact by email in omnisend-update-contact (or new omnisend-unsubscribe-contact action)](https://github.com/PipedreamHQ/pipedream/issues/21390)
- [Gorgias create ticket message action doesn't allow WhatsApp as a source](https://github.com/PipedreamHQ/pipedream/issues/21389)
...
## [flashtrace/flashtrace](https://github.com/flashtrace/flashtrace)

- [Recognize Setext (underlined) Markdown headings as item titles](https://github.com/flashtrace/flashtrace/issues/43)
- [Shortform direct type needs.](https://github.com/flashtrace/flashtrace/issues/22)
...
- [Add dark mode support to the application](https://github.com/Prashant-Singh-Rawat/Tony-AI-Health-Analysis-System/issues/14)
