...
- [[Community] Member Profile: Kavitha Karunakaran](https://github.com/layer5io/layer5/issues/7422)
...
- [Add Templates for issues and PR](https://github.com/sarojit049/Fleetiva-Roadlines/issues/99)
...
- [Incorrect bundle paths when bundles are in multiple directories. ](https://github.com/webpack/webpack-bundle-analyzer/issues/506)
...
- [Fix JavaScript lint errors](https://github.com/stdlib-js/stdlib/issues/10285)
- [Fix JavaScript lint errors](https://github.com/stdlib-js/stdlib/issues/10264)
...
- [[p5.js 2.0 Bug Report]: build*Shader methods don't work yet in instance mode](https://github.com/processing/p5.js/issues/8520)
...
## [nem-web/smart-attendance](https://github.com/nem-web/smart-attendance)

- [[BUG] : Recurring Timetable Section Has No Working Logic](https://github.com/nem-web/smart-attendance/issues/204)
- [[BUG] : Exam Days Feature Visible but Not Functional](https://github.com/nem-web/smart-attendance/issues/203)
...
## [ahmadjani/full_stack_capstone](https://github.com/ahmadjani/full_stack_capstone)

- [Register User](https://github.com/ahmadjani/full_stack_capstone/issues/2)
- [View Gift List](https://github.com/ahmadjani/full_stack_capstone/issues/1)
...
- [[ENHANCEMENT] Product Quick View Modal](https://github.com/BDutta18/CITY-STYLE/issues/81)
...
- [Standard Profile Feature](https://github.com/BDutta18/CITY-STYLE/issues/65)

## [KaranUnique/CryptoHub](https://github.com/KaranUnique/CryptoHub)

- [UI Bug: Footer description text under logo is misaligned](https://github.com/KaranUnique/CryptoHub/issues/293)
- [[BUG] Remove the double underline for the navbar links](https://github.com/KaranUnique/CryptoHub/issues/253)
...
## [JouTak/JouTakWeb](https://github.com/JouTak/JouTakWeb)

- [Проработка страницы: 403 -- Forbidden](https://github.com/JouTak/JouTakWeb/issues/58)
- [Проработка страницы: 404 -- Not Found](https://github.com/JouTak/JouTakWeb/issues/57)

## [gbowne1/codestream](https://github.com/gbowne1/codestream)

- [Validate roomId in WebRTC signaling handlers](https://github.com/gbowne1/codestream/issues/106)
- [Restrict start-stream event to authenticated users](https://github.com/gbowne1/codestream/issues/105)
- [[TODO][Enhance] Separate main.js](https://github.com/gbowne1/codestream/issues/78)
- [[Enhancement] add /health endpoint](https://github.com/gbowne1/codestream/issues/76)
- [Fix: Service Worker Fails to Fetch Uncached Resources](https://github.com/gbowne1/codestream/issues/2)
- [[TODO] separate frontend code from backend code](https://github.com/gbowne1/codestream/issues/77)
- [[Enhancement] use fs.promises.readFile](https://github.com/gbowne1/codestream/issues/75)
- [Fix live indicator accessibility and viewer count updates](https://github.com/gbowne1/codestream/pull/40)
- [[Feature] Add a chat and use websockets](https://github.com/gbowne1/codestream/issues/52)
