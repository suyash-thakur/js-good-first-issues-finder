...
- [(Bash) Highlighted colors doesn't look correct](https://github.com/highlightjs/highlight.js/issues/4288)
...
## [ZFordDev/SnapDock](https://github.com/ZFordDev/SnapDock)

- [find box changes containing bar size](https://github.com/ZFordDev/SnapDock/issues/222)
- [Document Outline Panel](https://github.com/ZFordDev/SnapDock/issues/148)

## [santifer/career-ops](https://github.com/santifer/career-ops)

- [ollama-eval.mjs doesn't include config/profile.yml or modes/_profile.md in the prompt (unlike gemini-eval.mjs/openai-eval.mjs)](https://github.com/santifer/career-ops/issues/2488)
- [feat(cv): make Work Experience an optional section](https://github.com/santifer/career-ops/issues/2504)
- [feat(cli): stats.mjs has no --help — add the usage block](https://github.com/santifer/career-ops/issues/2476)
...
- [Move node color gradient to front](https://github.com/YanivZalach/IceGraph/issues/79)
- [Show partition statistics in the FileTree page](https://github.com/YanivZalach/IceGraph/issues/112)
- [Env class](https://github.com/YanivZalach/IceGraph/issues/51)
...
- [Partial graph load: isolate per-file collection errors + change delete-file color](https://github.com/YanivZalach/IceGraph/issues/97)
...
- [Good First Issue: Add ESLint Rule for Validating Avenx Component Tag Naming Conventions](https://github.com/Avenx-JS/avenx-js/issues/940)
...
- [Good First Issue: Add TypeScript Definitions for Resource and AvenxGuard in lib/core/index.d.ts](https://github.com/Avenx-JS/avenx-js/issues/936)
- [Good First Issue: Implement AvenxWatcher.pause() and AvenxWatcher.resume() Methods](https://github.com/Avenx-JS/avenx-js/issues/935)
- [Good First Issue: Add --force Overwrite Option to avenx generate CLI Command](https://github.com/Avenx-JS/avenx-js/issues/934)
- [Good First Issue: Document <VirtualList /> Built-in Component Usage and Performance Patterns](https://github.com/Avenx-JS/avenx-js/issues/926)
- [Good First Issue: Document avenx doctor Command in CLI Reference](https://github.com/Avenx-JS/avenx-js/issues/925)
...
- [Good First Issue: Document Deep Scoped CSS Selectors (`:deep()` and `::v-deep`) in Styling Guide](https://github.com/Avenx-JS/avenx-js/issues/904)
...
- [UI RFE: order of canvas nav controls](https://github.com/ProjectMirador/mirador/issues/3190)
...
- [[a11y-base] Move orientation property from ListMixin to tabs](https://github.com/vaadin/web-components/issues/12224)
