...
## [Weiss-UltimateSavior/Tyranor-Next](https://github.com/Weiss-UltimateSavior/Tyranor-Next)

- [功能增强：Artemis引擎对BC 7格式素材支持](https://github.com/Weiss-UltimateSavior/Tyranor-Next/issues/78)
- [功能增强：为RPG MV 和 RPG MZ增加汉化功能](https://github.com/Weiss-UltimateSavior/Tyranor-Next/issues/36)
- [功能增强：添加外置显式跳转的支持](https://github.com/Weiss-UltimateSavior/Tyranor-Next/issues/28)
...
## [NuSkooler/enigma-bbs](https://github.com/NuSkooler/enigma-bbs)

- [msg_list repeats the focused-row lookup, and its menus copy the quit bindings instead of referencing them](https://github.com/NuSkooler/enigma-bbs/issues/815)
- [Message list: hot key to jump back to the first unread message](https://github.com/NuSkooler/enigma-bbs/issues/197)

## [ZORYQ-Network/ZORYQ](https://github.com/ZORYQ-Network/ZORYQ)

- [[External operator challenge] Run an independent ZORYQ Node 2 and reproduce the developer path](https://github.com/ZORYQ-Network/ZORYQ/issues/73)
- [[External Task] Verify one useful OBEP-bound task result and settlement](https://github.com/ZORYQ-Network/ZORYQ/issues/130)
- [[External Proof] Independently verify the first OBEP live Testnet Proof Pack](https://github.com/ZORYQ-Network/ZORYQ/issues/129)
- [[External Factory challenge] Reproduce a real multi-module app from one prompt](https://github.com/ZORYQ-Network/ZORYQ/issues/107)
- [[P0 traction] Reach 5 independent developers, 1 external app and 1 pilot](https://github.com/ZORYQ-Network/ZORYQ/issues/103)
- [[Good first issue] Add a one-command ZORYQ testnet connectivity check](https://github.com/ZORYQ-Network/ZORYQ/issues/43)
- [[Good first issue] Add an ethers v6 read-only starter for ZORYQ](https://github.com/ZORYQ-Network/ZORYQ/issues/17)
- [[Good first issue] Build a minimal viem starter dApp for ZORYQ](https://github.com/ZORYQ-Network/ZORYQ/issues/16)
- [[Good first issue] Add a Hardhat deployment example for ZORYQ](https://github.com/ZORYQ-Network/ZORYQ/issues/14)
- [[Good first issue] Add an Explorer copy/share helper](https://github.com/ZORYQ-Network/ZORYQ/issues/23)
- [[Good first issue] Add a ZORYQ agent action example](https://github.com/ZORYQ-Network/ZORYQ/issues/22)
- [[Good first issue] Add a faucet status component](https://github.com/ZORYQ-Network/ZORYQ/issues/21)
- [[Good first issue] Add a wallet-network status badge for ZORYQ](https://github.com/ZORYQ-Network/ZORYQ/issues/20)
- [[Good first issue] Add DEX live-reserve mini widget](https://github.com/ZORYQ-Network/ZORYQ/issues/19)
- [[Good first issue] Build a Project Registry read-only viewer](https://github.com/ZORYQ-Network/ZORYQ/issues/18)
- [[Good first issue] Improve ZORYQ Explorer mobile UX](https://github.com/ZORYQ-Network/ZORYQ/issues/15)

## [atomantic/PortOS](https://github.com/atomantic/PortOS)

- [[a11y-page-heading-outline] Five routes including the Dashboard landing page render no h1, inverting the heading outline](https://github.com/atomantic/PortOS/issues/7245)
- [[a11y-handrolled-tablists-bypass-tabpills] Four hand-rolled tablists never got the roving tabindex and arrow keys TabPills has](https://github.com/atomantic/PortOS/issues/7244)
